module Ccd
  class VitalSignsSectionEntriesRequired < ::Cda::Section
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.2.4.1'

    #SHALL contain exactly one [1..1] code (CONF:15962).
    constraint 'code', cardinality: '1..1'

    #This code SHALL contain exactly one [1..1] @code="8716-3" Vital Signs (CodeSystem: LOINC 2.16.840.1.113883.6.1 STATIC) (CONF:15963).
    ...
    Ccd.load_extension('VitalSignsSectionEntriesRequired')
  end
end
