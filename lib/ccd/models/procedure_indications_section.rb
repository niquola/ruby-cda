module Ccd
  class ProcedureIndicationsSection < ::Cda::Section
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.2.29'
    ...
    constraint 'code.code', cardinality: '1..1', value: '59768-2'
    ...
    Ccd.load_extension('ProcedureIndicationsSection')
  end
end
