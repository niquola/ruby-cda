module Ccd
  class HospitalDischargeDiagnosis < ::Cda::Act
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.4.33'

    #SHALL contain exactly one [1..1] code (CONF:19147).
    constraint 'code', cardinality: '1..1'

    #This code SHALL contain exactly one [1..1] @code="11535-2" Hospital discharge diagnosis (CodeSystem: LOINC 2.16.840.1.113883.6.1 STATIC) (CONF:19148).
    constraint 'code.code', cardinality: '1..1', value: '11535-2'
    ...
    Ccd.load_extension('HospitalDischargeDiagnosis')
  end
end
