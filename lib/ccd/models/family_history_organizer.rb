module Ccd
  class FamilyHistoryOrganizer < ::Cda::Organizer
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.4.45'
    ...
    constraint 'subject.relatedSubject', cardinality: '1..1'
    ...
    constraint 'subject.relatedSubject.classCode', cardinality: '1..1', value: 'PRS'

    #This relatedSubject SHALL contain exactly one [1..1] code (CONF:15246).
    constraint 'subject.relatedSubject.code', cardinality: '1..1'
    ...
    constraint 'subject.relatedSubject.code.code', cardinality: '1..1'

    #This relatedSubject SHOULD contain zero or one [0..1] subject (CONF:15248).
    constraint 'subject.relatedSubject.subject', cardinality: '0..1'

    #The subject, if present, SHALL contain exactly one [1..1] administrativeGenderCode (CONF:15974).
    constraint 'subject.relatedSubject.subject.administrativeGenderCode', cardinality: '1..1'
    ...
    constraint 'subject.relatedSubject.subject.administrativeGenderCode.code', cardinality: '1..1'

    #The subject, if present, SHOULD contain zero or one [0..1] birthTime (CONF:15976).
    constraint 'subject.relatedSubject.subject.birthTime', cardinality: '0..1'
    ...
    constraint 'subject.relatedSubject.subject'
