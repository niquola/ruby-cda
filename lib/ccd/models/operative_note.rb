module Ccd
  class OperativeNote < ::Cda::ClinicalDocument
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.1.7'
    ...
    constraint 'documentationOf.serviceEvent.performer.assignedEntity.code', cardinality: '1..1'
    ...
    Ccd.load_extension('OperativeNote')
  end
end
