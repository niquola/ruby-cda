module Ccd
  class HospitalConsultationsSection < ::Cda::Section
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.2.42'

    #SHALL contain exactly one [1..1] code (CONF:15485).
    constraint 'code', cardinality: '1..1'

    #This code SHALL contain exactly one [1..1] @code="18841-7" Hospital Consultations Section (CONF:15486).
    constraint 'code.code', cardinality: '1..1', value: '18841-7'
    ...
    Ccd.load_extension('HospitalConsultationsSection')
  end
end
