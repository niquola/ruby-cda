module Ccd
  class ImplantsSection < ::Cda::Section
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.2.33'
    ...
    constraint 'code.codeSystem', cardinality: '0..1', value: '2.16.840.1.113883.6.1'
    ...
    Ccd.load_extension('ImplantsSection')
  end
end
