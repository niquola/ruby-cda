module Ccd
  class AssessmentScaleObservation < ::Cda::Observation
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.4.69'
    ...
    constraint 'derivationExpr', cardinality: '0..1'
    ...
    constraint 'interpretationCode.translation', cardinality: '0..*'
    ...
    constraint 'referenceRange.observationRange.text', cardinality: '0..1'

    #The text, if present, SHOULD contain zero or one [0..1] reference (CONF:16802).
    constraint 'referenceRange.observationRange.text.reference', cardinality: '0..1'

    #The reference, if present, MAY contain zero or one [0..1] @value (CONF:16803).
    constraint 'referenceRange.observationRange.text.reference.value', cardinality: '0..1'
