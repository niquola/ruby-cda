module Ccd
  class PressureUlcerObservation < ::Cda::Observation
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.22.4.70'
    ...
    constraint 'targetSiteCode.qualifier', cardinality: '0..1'

    #The qualifier, if present, SHALL contain exactly one [1..1] name (CONF:14800).
    constraint 'targetSiteCode.qualifier.name', cardinality: '1..1'
    ...
    constraint 'targetSiteCode.qualifier.name.code', cardinality: '0..1', value: '272741003'

    #The qualifier, if present, SHALL contain exactly one [1..1] value (CONF:14802).
    constraint 'targetSiteCode.qualifier.value', cardinality: '1..1'
    ...
    constraint 'targetSiteCode.qualifier.value.code', cardinality: '0..1'
    ...
    constraint 'entryRelationship.observation.code', cardinality: '1..1'
    ...
    constraint 'entryRelationship.observation.code.code', cardinality: '1..1', value: '401238003'
    ...
    constraint 'entryRelationship.observation.code.code', cardinality: '1..1', value: '401239006'
    ...
    constraint 'entryRelationship.observation.code.code', cardinality: '1..1', value: '425094009'
