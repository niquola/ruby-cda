module Ccd
  class SubjectiveSection < ::Cda::Section
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '2.16.840.1.113883.10.20.21.2.2'

    #SHALL contain exactly one [1..1] code (CONF:15437).
    constraint 'code', cardinality: '1..1'

    #This code SHALL contain exactly one [1..1] @code="61150-9" Subjective (CONF:15438).
    constraint 'code.code', cardinality: '1..1', value: '61150-9'
    ...
    Ccd.load_extension('SubjectiveSection')
  end
end
