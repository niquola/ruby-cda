module Ccd
  class HospitalCourseSection < ::Cda::Section
    ...
    constraint 'templateId.root', cardinality: '1..1', value: '1.3.6.1.4.1.19376.1.5.3.1.3.5'

    #SHALL contain exactly one [1..1] code (CONF:15487).
    constraint 'code', cardinality: '1..1'

    #This code SHALL contain exactly one [1..1] @code="8648-8" Hospital Course (CONF:15488).
    constraint 'code.code', cardinality: '1..1', value: '8648-8'
    ...
    Ccd.load_extension('HospitalCourseSection')
  end
end
