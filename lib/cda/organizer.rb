class Cda::Organizer < Cda::Base
  ...
  attribute :class_code, Cda::XActClassDocumentEntryOrganizer, annotations: {:use=>:required, :kind=>:attribute, :class=>"Cda::XActClassDocumentEntryOrganizer"}
  attribute :mood_code, Cda::ActMood, annotations: {:use=>:required, :kind=>:attribute, :class=>"Cda::ActMood"}
end
