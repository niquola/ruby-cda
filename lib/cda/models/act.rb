class Cda::Act < Cda::Base
  ...
  attribute :class_code, Cda::XActClassDocumentEntryAct, annotations: {:use=>:required, :kind=>:attribute, :class=>"Cda::XActClassDocumentEntryAct"}
  attribute :mood_code, Cda::XDocumentActMood, annotations: {:use=>:required, :kind=>:attribute, :class=>"Cda::XDocumentActMood"}
